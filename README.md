...
What attracts me to computing is that while frameworks, libraries, and trends evolve rapidly, the first principles remain remarkably stable. Data structures, algorithms, mathematics, optimization, systems design, and fundamental engineering concepts continue to matter regardless of the technology stack. I find greater satisfaction in implementing a chess engine than building a chess application around an existing engine API, or in understanding the internals of a system rather than simply connecting pre-built services together. I enjoy building things with depth—projects where the core logic, reasoning, and engineering decisions are as important as the final interface.
